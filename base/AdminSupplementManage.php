...
?>
        ...
        <div class="row" style="margin-bottom: 20px; text-align: left">
            <div class="col-lg-12">
                <a href="AdminNewSupplement.php" class="btn btn-success " >新增補充資料類別</a>
                <a href="AdminNewSupplementFile.php" class="btn btn-success " >建立新補充資料</a>
...
if (!($_GET["type"]) || $_GET["type"] == "all") {
    $sql_tid = "SELECT s.*,t.* FROM supplements s,spm_types t where save='0' and s.spt_id=t.spt_id order by t.listorder";
    ...
    $sqlresult = "SELECT s.*,t.* FROM supplements s,spm_types t where save='0' and s.spt_id=t.spt_id order by t.listorder Limit $start , $per";
