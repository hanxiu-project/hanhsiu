    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class='wrapper'>
                ...
                <?php
                    $sql = "SELECT * FROM slogan where `sloganid`= '5'";
                ...
                <?php	
                    if (isset($_POST["go"])) {
                        if ($_POST["slogan"] == null) {
                            echo "<script>alert('更改內容不能為空值');location.href='AdminReadSloganEdit.php'</script>";
                        } 
                        else {
                            $sql_insert = "UPDATE `slogan` set `slogantext`='$_POST[slogan]' where `sloganid` = '5'";
                            mysqli_query($db_link, $sql_insert);
                            echo "<script>alert('更改成功');location.href='AdminReadSloganEdit.php'</script>";
                        }
                    }
