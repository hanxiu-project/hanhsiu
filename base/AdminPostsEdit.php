                    ...
                    if (isset($_POST["edit"])) {
                        if ($row["old"] != 1) /*如果該公告不是歷史公告的話*/ {
                            ...
                            if ($_POST["title"] == null || $_POST["content"] == null) {
                                ...
                                $sqledit = "UPDATE posts SET `top`='$checked', `title` = '$_POST[title]', `content` = '$_POST[content]' ,`date` = '$_POST[date]' ,`newday`='$_POST[newday]', `save`='0', `old` = '0' WHERE posts.p_id = $_SESSION[edit_p_id] ";
                                mysqli_query($db_link, $sqledit);
                                if ($_POST['top'] == '1') {
