...
if (!($_GET["type"]) || $_GET["type"] == "all") {
    $sql_tid = "SELECT s.*,t.* FROM supplements s,spm_types t where save='1' and s.spt_id=t.spt_id order by t.listorder";
    ...
    $sqlresult = "SELECT s.*,t.* FROM supplements s,spm_types t where save='1' and s.spt_id=t.spt_id order by t.listorder Limit $start , $per";
