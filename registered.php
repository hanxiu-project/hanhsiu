                    ...
                    <div class="w-1000 mx-auto">
                       ...
                       <!--<form class="mt-4" action="login.php">-->
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-7 col-lg-9">
                                    <input type="tel" class="form-control" name="inputPhone" id="inputPhone" placeholder="請輸入手機號碼" />
                                </div>
                            </div>
                            <div class="mb-3 row">
        ...
        <?php
          ...
          if (isset($_POST["gore"]))
          {
              ...
              if ($_POST['inputAccount'] == null || $_POST['inputPassword'] == null || $_POST['inputPasswordAgain'] == null || $_POST['inputName'] == null || $_POST['sex'] == null || $_POST['inputEmail'] == null || $_POST['inputPhone'] == null || $_POST['inputAddress'] == null) {
                  ...
                  $vkey = md5(time().$u);
                  $sql_insert = "INSERT INTO `members` (account,password,name,gender,email,address,telephone,authority,vkey) VALUES ('$_POST[inputAccount]','$_POST[inputPassword]','$_POST[inputName]','$_POST[sex]','$_POST[inputEmail]','$_POST[inputAddress]','$_POST[inputPhone]','0','$vkey')";
